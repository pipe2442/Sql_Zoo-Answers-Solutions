...
The * says to list all the columns in the table - a shorter way of 
...
in the game table. We can look up information about game 1012 by finding that 
...
in a game where the stadium was 'National 
Stadium, Warsaw'*/
